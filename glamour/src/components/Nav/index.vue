  ...
  <nav>
    <div class="top">
      ...
      <div class="right">
        ...
        <RouterLink to="/login">{{ t("navigation.login") }} <CgProfile /></RouterLink>
        <RouterLink to="/wishlist">{{ t("navigation.wishlist") }} <CiHeart /></RouterLink>
        <RouterLink to="/cart"><MdOutlineShoppingCart /></RouterLink>
      </div>
    </div>
    <div class="bottom">
      <div class="left">
